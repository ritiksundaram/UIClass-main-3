...
const LowerMachine = ({ onReset }) => {
  ...
  useEffect(() => {
    fetch("/api/data").then(
      ...
      data => {
        ...
        const capacityData = data.LOCATIONS["Lower Machine"];
  ...
  return (
    <div id="Lower Machine Area" class="info">
      <span class="bolded"> Lower Machine Area: </span>
      ...
      <br></br>
      <a target="_blank" href="https://recreation.columbia.edu/booking" className="underlined">
        Reserve cardio equipment
      </a>
      <br /><br />
      ...
      <span> Historical: </span>
        <br></br>
        <br></br>
      <History location="Lower Machine" />
      <br></br>
    </div>
